    ...
    https.get(url, function (response) {
        ...
        if (response.statusCode == 200) {
            response.on("data", function (data) {
                ...
                <hr class= "my-4"> 
                <p>The temperature in <strong>` + query + `</strong> is <em><u> ` + temp + `</u></em> degrees Celcius.</p> <p>The weather is currently <strong>` + weatherDescription + `</strong></p>
                <img src="` + iconUrl + `" width="70" height="70"> </div >
